...
func (*Series) TableName() string {
	return path.Join(prefix, "series")
}

func (*Seasons) TableName() string {
	return path.Join(prefix, "seasons")
}

func (*Episodes) TableName() string {
	return path.Join(prefix, "episodes")
}

func (*TestEpisodes) TableName() string {
	return path.Join(prefix, "test/episodes")
}
